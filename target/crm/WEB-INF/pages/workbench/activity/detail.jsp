...
<script type="text/javascript">
	...
	$(function(){
			...
			$.ajax({
				...
				success:function (data){
					if (data.code=="200"){
						...
						htmlStr+="<h5 id=\"h5_"+data.retData.id+"\">"+noteContent+"</h5>";
		...
		$("#remarkDivList").on("click","a[name='editA']",function () {
			...
			$("#edit-id").val(id);
			$("#edit-noteContent").val(notContent);
			...
			$.ajax({
				...
				success:function (data) {
					if (data.code=="200"){
						...
						$("#div_"+data.retData.id+" h5").text(noteContent);
...
<body>
	...
	<div style="position: relative; top: -70px;">
		<div style="position: relative; left: 40px; height: 30px;">
			...
			<div style="width: 300px;position: relative; left: 650px; top: -60px;"><b>${activity.startDate}</b></div>
