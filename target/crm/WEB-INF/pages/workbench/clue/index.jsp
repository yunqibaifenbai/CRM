    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#saveCreateClueBtn").click(function () {
                ...
                //正则表达式验证
                var emaliExp = /^\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$/;
                if (!emaliExp.test(email)) {
                    alert("邮箱格式不正确")
                    return;
                }
                ...
                var webExp = /^(?:http(s)?:\/\/)?[\w.-]+(?:\.[\w\.-]+)+[\w\-\._~:/?#[\]@!\$&'\*\+,;=.]+$/;
                if (!webExp.test(website)) {
                    alert("公司网站格式不正确")
                    return;
                }
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.code == "200") {
                            ...
                            queryClueConditionForPages(1, $("#demo_pag1").bs_pagination('getOption', 'rowsPerPage'));
                        } else {
                            alert(data.message);
                        }
                    }
            ...
            queryClueConditionForPages(1, 10);
            //
        ...
        function queryClueConditionForPages(pageNo, pageSize) {
            //收集参数
            ...
            $.ajax({
                ...
                success: function (data) {
                    var htmlStr = "";
                    $.each(data.retData.clueList, function (index, obj) {
                    ...
                    $("#demo_pag1").bs_pagination({
                        ...
                        onChangePage: function (event, pageObj) {
                            queryClueConditionForPages(pageObj.currentPage, pageObj.rowsPerPage);
                        }
                    })
                }
            });
